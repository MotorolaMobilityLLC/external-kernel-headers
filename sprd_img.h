...
#define SPRD_IMG_IO_DISABLE_MODE      _IOW(SPRD_IMG_IO_MAGIC, 23, uint32_t)
#define SPRD_IMG_IO_ENABLE_MODE       _IOW(SPRD_IMG_IO_MAGIC, 24, uint32_t)
