...
#ifndef GSP_R3P0_CFG_H_
#define GSP_R3P0_CFG_H_
...
enum gsp_r3p0_qword_endian {
	GSP_R3P0_QWORD_ENDN_0 = 0x00,	 /*B15B14B13B12_B11B10B9B8_B7B6B5B4_B3B2B1B0*/
	GSP_R3P0_QWORD_ENDN_1,			/*B7B6B5B4_B3B2B1B0_B15B14B13B12_B11B10B9B8*/
