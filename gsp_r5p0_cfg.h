...
#ifndef GSP_R5P0_CFG_H_
#define GSP_R5P0_CFG_H_
...
enum gsp_r5p0_word_endian {
	GSP_R5P0_WORD_ENDN_0 = 0x00,	 /*B3B2B1B0*/
	GSP_R5P0_WORD_ENDN_1,			/*B0B1B2B3*/
	GSP_R5P0_WORD_ENDN_2,			/*B1B0B3B2*/
	GSP_R5P0_WORD_ENDN_3,			/*B2B3B0B1*/
	GSP_R5P0_WORD_ENDN_MAX_NUM,
};

enum gsp_r5p0_dword_endian {
	GSP_R5P0_DWORD_ENDN_0 = 0x00,	 /*B7B6B5B4_B3B2B1B0*/
	GSP_R5P0_DWORD_ENDN_1,			/*B3B2B1B0_B7B6B5B4*/
